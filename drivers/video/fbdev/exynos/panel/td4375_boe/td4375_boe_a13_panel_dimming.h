/*
 * linux/drivers/video/fbdev/exynos/panel/td4375_boe/td4375_boe_a13_panel_dimming.h
 *
...
#ifndef __TD4375_A13_PANEL_DIMMING_H___
#define __TD4375_A13_PANEL_DIMMING_H___
...
#define TD4375_NR_STEP (256)
#define TD4375_HBM_STEP (51)
#define TD4375_TOTAL_STEP (TD4375_NR_STEP + TD4375_HBM_STEP) /* 0 ~ 365 */

static unsigned int td4375_boe_a13_brt_tbl[TD4375_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int td4375_boe_a13_step_cnt_tbl[TD4375_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table td4375_boe_a13_panel_brightness_table = {
	.brt = td4375_boe_a13_brt_tbl,
	.sz_brt = ARRAY_SIZE(td4375_boe_a13_brt_tbl),
	.sz_ui_brt = TD4375_NR_STEP,
	.sz_hbm_brt = TD4375_HBM_STEP,
	.lum = NULL,
	.sz_lum = 0,
	.sz_ui_lum = 0,
	.sz_hbm_lum = 0,
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = td4375_boe_a13_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(td4375_boe_a13_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info td4375_boe_a13_panel_dimming_info = {
	.name = "td4375_boe_a13",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &td4375_boe_a13_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __TD4375_A13_PANEL_DIMMING_H___ */
