/*
 * linux/drivers/video/fbdev/exynos/panel/nt36672c_tianma/nt36672c_tianma_a13_panel_dimming.h
 *
...
#ifndef __NT36672C_A13_PANEL_DIMMING_H___
#define __NT36672C_A13_PANEL_DIMMING_H___
...
static unsigned int nt36672c_tianma_a13_brt_tbl[NT36672C_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int nt36672c_tianma_a13_step_cnt_tbl[NT36672C_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table nt36672c_tianma_a13_panel_brightness_table = {
	.brt = nt36672c_tianma_a13_brt_tbl,
	.sz_brt = ARRAY_SIZE(nt36672c_tianma_a13_brt_tbl),
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = nt36672c_tianma_a13_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(nt36672c_tianma_a13_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info nt36672c_tianma_a13_panel_dimming_info = {
	.name = "nt36672c_tianma_a13",
	.dim_init_info = {
		NULL,
	},
	.target_luminance = -1,
	...
	.brt_tbl = &nt36672c_tianma_a13_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __NT36672C_A13_PANEL_DIMMING_H___ */
